...
export function CampaignParallaxImage({
  className,
  foregroundImage,
  campaignName,
}: Props) {
  ...
  return (
    <div className={clsx("grid grid-cols-1 place-items-center", className)}>
      ...
      >
        <Image
          src="/Z1UNmpbqstJ98M3k_paint-background.png"
          alt=""
          width={1080}
          height={1080}
          className="w-11/12"
      ...
      <div
        ref={foregroundRef}
        className="col-start-1 row-start-1 transition-transform h-full w-full grid place-items-center"
      >
        {foregroundImage ? (
          <Image
            src={foregroundImage}
          ...
          <div className="h-full max-h-[500px] w-auto flex items-center justify-center">
            <span className="text-white/50 text-lg">Campaign Image</span>
          </div>
        )}
      </div>
    </div>
